...
import (
	...
	"github.com/drop-the-mic/operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0c42dca4.dtm.io",
	...
	stateStore := state.NewStore(5)

	if err := (&controller.ChecklistPolicyReconciler{
		Client:     mgr.GetClient(),
		Scheme:     mgr.GetScheme(),
		KubeClient: kubeClient,
		Store:      stateStore,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "ChecklistPolicy")
		os.Exit(1)
	}
